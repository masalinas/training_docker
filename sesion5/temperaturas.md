...
Puedes encontrar el fichero `docker-compose.yml` en en este [directorio](https://github.com/masalinas/training_docker/tree/main/ejemplos/sesion5/ejemplo2) del repositorio.
